...
public class UserUpdateDto implements org.apache.thrift.TBase<UserUpdateDto, UserUpdateDto._Fields>, java.io.Serializable, Cloneable, Comparable<UserUpdateDto> {
  ...
  public UserUpdateDto setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UserUpdateDto setAddr(@org.apache.thrift.annotation.Nullable String addr) {
    this.addr = addr;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserUpdateDto(");
    boolean first = true;
